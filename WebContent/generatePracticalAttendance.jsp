...
<html>
<head>
<title>Generate Practical Attendance</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 offset-md-1">
				...
				<form action="generatePracticalStatus"
					name="generatePracticalStatus" class="form-data" method="post">
					<h4 class="text-center">Generate Practical Attendance</h4>
							...
							<div class="form-resp">
								...
								<div class="form-group">
									<label for="batch">Batch</label> <select
										class="form-control form-control-md" id="divsion" name="batch">
										<%
