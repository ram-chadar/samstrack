...
<html>
<head>
<title>Sem Theory Attendance Result</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<form action="semAttendance" name="semAttendance"
					class="form-data">
					<%
							...
							{
								%>
						<h5 class="text-center">SEM ATTENDANCE RESULT</h5>
					...
					<div class="row">
						<div class="col-md-4 col-xs-12">
							...
							<div class="form-resp">
								...
								<div class="form-group">
									<label for="month">Month From</label> <select
								...
								<div class="form-group">
									<label for="month">Month To</label> <select
										...
										String emonth=(String)request.getAttribute("emonth");
											if(emonth!=null)
											{
												...
												%>
										<option disabled="disabled" value="">To</option>
										<option value="01">01</option>
										<option value="02">02</option>
										<option value="03">03</option>
										<option value="04">04</option>
								...
								<div>
									<button type="submit" class="btn btn-primary btn-block "
										value="class" name="action">Theory Attendnce</button>
									<button type="submit" class="btn btn-primary btn-block "
								...
								<div class="table-data">
									<table class="table table-dark table-striped" border="1" id="example" style="width: 100%">
										...
										<tbody>
											...
											<%
												Iterator itr2;
												List totalDate = (List) request.getAttribute("totaldatesem");
												if (totalDate != null) {
