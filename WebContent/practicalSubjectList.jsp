...
<body>
	...
	<div class="form-resp">
		<h3 class="text-center">All Practical Subjects</h3>
			...
			<table class="table table-dark table-striped" border="1" id="example">
				<thead>
					<tr>
						...
						<th  class="text-center" style="width: 5%">Sem</th>
						<th  class="text-center"style="width: 10%">Subject Name</th>
						<th  class="text-center" style="width: 10%">Subject Code</th>
				...
				<tbody id="myTable">
					<c:forEach items="${subjects}" var="subject">
						<tr>							
							...
							<td  class="text-center"><c:out value="${subject.subjectName}" /></td>
							<td  class="text-center"><c:out value="${subject.subjectCode}" /></td>
							<td  class="text-center"><a class="clickme lookdanger"
								href="deletePracticalSubject?branchName=${subject.branchName}&sem=${subject.sem}&subjectName=${subject.subjectName}"onclick="if(!(confirm('Are You Sure To Delete'))) return false">Delete</a>
							</td>
