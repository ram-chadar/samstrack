	...
	<div class="text-cenetr">
		<div class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<a class="navbar-brand" href="home.jsp"> <img
				src="login/images/icons/logo.ico" width="30" height="30">
			</a>
					...
					<li class="nav-item dropdown active"><a
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown1">
							...
							<li class="dropdown-item dropdown"><a
								...
								aria-haspopup="true" aria-expanded="false">Subject</a>
								<ul class="dropdown-menu" aria-labelledby="dropdown2-1">
									<li class="dropdown-item"><a href="subjectDetail.jsp">Theory</a></li>
									<li class="dropdown-item"><a href="practicalSubject.jsp">Practical</a></li>
								</ul></li>
					...
					<li class="nav-item dropdown active"><a
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown1">
							...
							<li class="dropdown-item"><a href="studentBatch.jsp">Generate
									Batch</a></li>
							<li class="dropdown-item"><a href="updateAccYear">Update
									Accadmic Year</a></li>
 ...
 -->
					...
					<li class="nav-item dropdown active"><a
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown1">
							...
							<li class="dropdown-item"><a
								href="practicalStatusOption.jsp">Practical</a></li>

						</ul></li>

					<li class="nav-item dropdown active"><a
						class="nav-link dropdown-toggle" id="dropdown1"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Overall
							Status</a>
						<ul class="dropdown-menu" aria-labelledby="dropdown1">
							<li class="dropdown-item"><a href="overAllClassStatus.jsp">Theory</a></li>
							<li class="dropdown-item"><a
								href="overAllPracticalStatus.jsp">Practical</a></li>
					...
					<li class="nav-item dropdown active"><a
						...
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">User
							Detail</a>
						<ul class="dropdown-menu" aria-labelledby="dropdown1">
							<li class="dropdown-item"><a href="userDetail.jsp">Add
									User</a></li>
							<li class="dropdown-item"><a href="listOfUsers">View All
									User</a></li>

							<!-- <li class="dropdown-item"><a href="subjectDetail.jsp">Subject</a></li> -->
							<li class="dropdown-item dropdown"><a
								class="dropdown-toggle" id="dropdown2-1" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false">Allocate Subjects</a>
								<ul class="dropdown-menu" aria-labelledby="dropdown2-1">
									<li class="dropdown-item"><a
										href="allocateClassSubject.jsp">Theory</a></li>
									<li class="dropdown-item"><a
										href="allocatePracticalSubject.jsp">Practical</a></li>
								</ul></li>
