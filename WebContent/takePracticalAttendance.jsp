...
<link rel="stylesheet" type="text/css"
	href="onlineCss/pretty-checkbox.min.css">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-md-1">
				<form action="takePracticalAttendance"
					name="takePracticalAttendance" class="form-data">
					<h3 class="text-center">Take Practical Attendance</h3>
							...
							<div class="form-resp">
								...
								<div>
									<button type="submit" class="btn btn-primary btn-block "
										value="Get Roll.NO" name="action">Get Roll.NO</button>
							...
							<div class="form-resp">
								<div class="button-group ">
									...
									<button type="button" class="btn btn-primary btn-block"
										value="Select All" onclick='selectAll()'>Select All</button>
									<button type="button" class="btn btn-primary btn-block "
										value="Un-Select All" onclick='UnSelectAll()'>UnSelect
										All</button>
								</div>

								<div class="table-data2">
									<table
										class="table table-dark table-striped table-bordered table-hover dataTables-example"
										border="1" id="example" style="width: 100%">
											...
											<c:forEach items="${students}" var="student">
												<tr>
													...
													<td class="text-center"><div
															...
															<input type="checkbox" id="rollNo" checked="checked"
																name="rollNo"
																value="<c:out value="${student.rollNo}" />" />
															<div class="state">
																<img class="image" src="img/check.png"> <label
																	style="color: #ffffff"><c:out
																		value="${student.rollNo}" /></label>
								...
								<br>
								<button type="submit" class="btn btn-primary btn-block "
									value="SUBMIT ATTENDANCE" name="action">SUBMIT
									ATTENDANCE</button>
						
								<button type="submit" class="btn btn-danger btn-block"
									value="Delete Attendance" name="action"
