	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<form action="practicalSubjectDetail" name="subjectDetail"
					class="form-data"">


					<div class="form-resp">
						<H3 class="text-center">Practical Subject Detail</H3>

						<div class="form-group">
							<label for="branchName">Select Branch</label> <select
								class="form-control form-control-md" id="bn" name="bn" required="required">
